...
$(".side-open-toggle").click(function () {
    isTrue
        ? ($(".nav-content").addClass("open-menu").removeClass("close-menu"),
            (navWidth = $(".nav-content").width()),
            $(".side-nav").css("left", navWidth + 20),
            ...
            (isTrue = !isTrue))
        : ($(".nav-content").addClass("close-menu").removeClass("open-menu"),
            $(".fa-align-justify").toggleClass("fa-times"),
            $(".side-nav").css("left", 0),
            $(".nav-content li").animate({ opacity: "0", paddingTop: "500px" }, 500),
            (isTrue = !isTrue));
});
...
function displayMeals(arr) {
    ...
    for (i = 0; i < arr.length; i++) {
        meals += `
        <div class="col-md-6 col-lg-3 my-3 myMini shadow">
            <div onclick="getMeal('${arr[i].idMeal}')" class="movie rounded position-relative">
                <div class="post">
...
function displayIngredients() {
    ...
    <div class="col-md-6 col-lg-3 my-3 myMiniini shadow">
        <div onclick="getMainIngredient('${arr[i].strIngredient}')" class="movie rounded position-relative">
            <div class="post ">
...
function displayMeal(meal) {
    ...
    let str = `
    <div class="col-md-4 myMini text-white">
					<img class="w-100 rounded-circle" src="${meal.strMealThumb}" alt=""
						srcset=""><br>
					<h1 class="text-center mt-3">${meal.strMeal}</h1>
				</div>
				<div class="col-md-8 myMini text-left text-white">
					<h2 >Instructions</h2>
					...
					<ul class="d-flex ps-0" id="recipes">
					</ul>

					<h3 class="fw-bolder my-2 mx-1 p-1">Tags :</h3>
					<ul class="d-flex ps-0" id="tags">
					</ul>

					
					<a class="ms-1 btn btn-success text-white shadow-none hvr" target="_blank" href="${meal.strSource}">Source</a>
					<a class="btn btn-danger text-white shadow-none hvr" target="_blank" href="${meal.strYoutube}">Youtub</a>
				</div>`;
    row.innerHTML = str;
...
$(".nav-item a").click(async (e) => {
    ...
    if (listBy == "contact") {
        row.innerHTML = `
        <section id="contact" class="container myMini w-75 mx-auto mb-5">
		<div class="p-2 text-center">
			<h2 class="text-light mb-5">Contac Us</h2>
			<div class="row">
				<div class="col-md-6">
                ...
                <div class="col-md-12">
                    <textarea class="form-control form-control-lg mb-3" name="" cols="" rows="3" placeholder="Enter your Message"></textarea>
    ...
    document.querySelector(".side-open-toggle").dispatchEvent(click_event);
